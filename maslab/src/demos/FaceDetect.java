...
public class FaceDetect {
    ...
    public static void detectAndDisplay(Mat frame)
    {
      ...
      //  Imgproc.cvtColor(frame, frame_gray, Imgproc.COLOR_BGR2GRAY);
       // System.out.println(frame_gray.type());
    ...
    */
    public static void main(String[] args)
    {
        ...
        CascadeClassifier face_cascade1 = new CascadeClassifier("~/projects/RobotX/opencv-2.4.8/data/haarcascades/haarcascade_frontalface_alt.xml"); 
